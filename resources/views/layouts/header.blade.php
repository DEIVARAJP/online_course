                        ...
                        <nav class="main-menu main-menu--1">
                            <div class="main-menu__inner">
                                <div class="left">
                                    <div class="logo-box1">
                                        <a href="{{route('home')}}">
                                            <img src="{{asset('assets/images/resources/logo-1.png')}}" width="150px"  alt="">
                                        </a>
                                    </div>
                                </div>
...
<!--
            ...
            <div style="background: #42378f;" class="main-header--two__top clearfix p-0">
                <div  class="container">
                    <div  class="main-header--two__top-inner clearfix">
                        <div class="main-header--two__top-left">
                            <ul class="main-header--two__top-contact-info list-unstyled my-0 py-2">
